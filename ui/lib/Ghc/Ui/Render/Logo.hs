...
import Brick (Padding (Pad), hBox, padTop, txt, vBox, withAttr)
import Brick.AttrMap (AttrName)
import Brick.Types (Widget (..))
import qualified Data.Text as Text
import Ghc.Ui.Attr (haskellLogoArrowAttr, haskellLogoEqualsAttr, haskellLogoLambdaAttr)
...
renderLogo =
  ...
  where
    ...
    lettering =
      hBox [
        withAttr haskellLogoArrowAttr (txt "   G H C"),
        withAttr haskellLogoLambdaAttr (txt "      S E R V E R")
      ]
