...
module Proto.GhcServer (
        GhcServer(..), Empty(), ExecuteCommand(),
        ExecuteCommand'EnvironmentEntry(), ExecuteResponse(), Json()
    ) where
...
instance Data.ProtoLens.Message Empty where
  messageName _ = Data.Text.pack "ghcserver.Empty"
...
{- | Fields :
         ...
         * 'Proto.GhcServer_Fields.payload' @:: Lens' Json Data.ByteString.ByteString@ -}
data Json
  = Json'_constructor {_Json'payload :: !Data.ByteString.ByteString,
                       _Json'_unknownFields :: !Data.ProtoLens.FieldSet}
  deriving stock (Prelude.Eq, Prelude.Ord)
instance Prelude.Show Json where
  showsPrec _ __x __s
    = Prelude.showChar
        ...
        (Prelude.showString
           (Data.ProtoLens.showMessageShort __x) (Prelude.showChar '}' __s))
instance Data.ProtoLens.Field.HasField Json "payload" Data.ByteString.ByteString where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _Json'payload (\ x__ y__ -> x__ {_Json'payload = y__}))
        Prelude.id
instance Data.ProtoLens.Message Json where
  messageName _ = Data.Text.pack "ghcserver.Json"
  packedMessageDescriptor _
    = "\n\
      \\EOTJson\DC2\CAN\n\
    ...
    = let
        payload__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              Data.ProtoLens.FieldDescriptor Json
      in
        Data.Map.fromList
          [(Data.ProtoLens.Tag 1, payload__field_descriptor)]
  unknownFields
    = Lens.Family2.Unchecked.lens
        _Json'_unknownFields
        (\ x__ y__ -> x__ {_Json'_unknownFields = y__})
  defMessage
    = Json'_constructor
        {_Json'payload = Data.ProtoLens.fieldDefault,
         _Json'_unknownFields = []}
  parseMessage
    = let
        loop :: Json -> Data.ProtoLens.Encoding.Bytes.Parser Json
        loop x
          = do end <- Data.ProtoLens.Encoding.Bytes.atEnd
               if end then
                   do (let missing = []
      ...
      in
        (Data.ProtoLens.Encoding.Bytes.<?>)
          (do loop Data.ProtoLens.defMessage) "Json"
  buildMessage
    = \ _x
        -> (Data.Monoid.<>)
             (let
             ...
             (Data.ProtoLens.Encoding.Wire.buildFieldSet
                (Lens.Family2.view Data.ProtoLens.unknownFields _x))
instance Control.DeepSeq.NFData Json where
  rnf
    = \ x__
        -> Control.DeepSeq.deepseq
             (_Json'_unknownFields x__)
             (Control.DeepSeq.deepseq (_Json'payload x__) ())
...
instance Data.ProtoLens.Service.Types.Service GhcServer where
  ...
  type ServiceMethods GhcServer = '["api", "events", "execute"]
  packedServiceDescriptor _
    = "\n\
      \\tGhcServer\DC2B\n\
      \\aExecute\DC2\EM.ghcserver.ExecuteCommand\SUB\SUB.ghcserver.ExecuteResponse\"\NUL\DC2/\n\
      \\ACKEvents\DC2\DLE.ghcserver.Empty\SUB\SI.ghcserver.Json\"\NUL0\SOH\DC2)\n\
      \\ETXApi\DC2\SI.ghcserver.Json\SUB\SI.ghcserver.Json\"\NUL"
...
instance Data.ProtoLens.Service.Types.HasMethodImpl GhcServer "events" where
  type MethodName GhcServer "events" = "Events"
  type MethodInput GhcServer "events" = Empty
  type MethodOutput GhcServer "events" = Json
  type MethodStreamingType GhcServer "events" = 'Data.ProtoLens.Service.Types.ServerStreaming
instance Data.ProtoLens.Service.Types.HasMethodImpl GhcServer "api" where
  type MethodName GhcServer "api" = "Api"
  type MethodInput GhcServer "api" = Json
  type MethodOutput GhcServer "api" = Json
  type MethodStreamingType GhcServer "api" = 'Data.ProtoLens.Service.Types.NonStreaming
...
packedFileDescriptor
  = "\n\
    ...
    \\SIExecuteResponse\DC2\ESC\n\
    \\texit_code\CAN\SOH \SOH(\ENQR\bexitCode\DC2\SYN\n\
    \\ACKstderr\CAN\STX \SOH(\tR\ACKstderr\"\a\n\
    \\ENQEmpty\" \n\
    \\EOTJson\DC2\CAN\n\
    \\apayload\CAN\SOH \SOH(\fR\apayload2\171\SOH\n\
    \\tGhcServer\DC2B\n\
    \\aExecute\DC2\EM.ghcserver.ExecuteCommand\SUB\SUB.ghcserver.ExecuteResponse\"\NUL\DC2/\n\
    \\ACKEvents\DC2\DLE.ghcserver.Empty\SUB\SI.ghcserver.Json\"\NUL0\SOH\DC2)\n\
    \\ETXApi\DC2\SI.ghcserver.Json\SUB\SI.ghcserver.Json\"\NULJ\143\ACK\n\
    ...
    \\n\
    \\n\
    \\STX\EOT\NUL\DC2\EOT\EOT\NUL\f\SOH\n\
    \\n\
    \\n\
    \\ETX\EOT\NUL\SOH\DC2\ETX\EOT\b\SYN\n\
    \\f\n\
    \\EOT\EOT\NUL\ETX\NUL\DC2\EOT\ENQ\STX\b\ETX\n\
    \\f\n\
    \\ENQ\EOT\NUL\ETX\NUL\SOH\DC2\ETX\ENQ\n\
    \\SUB\n\
    \\r\n\
    \\ACK\EOT\NUL\ETX\NUL\STX\NUL\DC2\ETX\ACK\EOT\DC2\n\
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\NUL\ENQ\DC2\ETX\ACK\EOT\t\n\
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\NUL\SOH\DC2\ETX\ACK\n\
    \\r\n\
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\NUL\ETX\DC2\ETX\ACK\DLE\DC1\n\
    \\r\n\
    \\ACK\EOT\NUL\ETX\NUL\STX\SOH\DC2\ETX\a\EOT\DC4\n\
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\SOH\ENQ\DC2\ETX\a\EOT\t\n\
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\SOH\SOH\DC2\ETX\a\n\
    \\SI\n\
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\SOH\ETX\DC2\ETX\a\DC2\DC3\n\
    \\v\n\
    ...
    \\CAN\EM\n\
    \\v\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX\v\STX$\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\EOT\DC2\ETX\v\STX\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ACK\DC2\ETX\v\v\ESC\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\SOH\DC2\ETX\v\FS\US\n\
    \\f\n\
    ...
    \\n\
    \\n\
    \\ETX\EOT\SOH\SOH\DC2\ETX\SO\b\ETB\n\
    \\v\n\
    \\EOT\EOT\SOH\STX\NUL\DC2\ETX\SI\STX\SYN\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ENQ\DC2\ETX\SI\STX\a\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\SOH\DC2\ETX\SI\b\DC1\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ETX\DC2\ETX\SI\DC4\NAK\n\
    \\v\n\
    \\EOT\EOT\SOH\STX\SOH\DC2\ETX\DLE\STX\DC4\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\ENQ\DC2\ETX\DLE\STX\b\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\SOH\DC2\ETX\DLE\t\SI\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\ETX\DC2\ETX\DLE\DC2\DC3\n\
    \\t\n\
    \\STX\EOT\STX\DC2\ETX\DC3\NUL\DLE\n\
    \\n\
    \\n\
    ...
    \\n\
    \\n\
    \\ETX\EOT\ETX\SOH\DC2\ETX\NAK\b\f\n\
    \\v\n\
    \\EOT\EOT\ETX\STX\NUL\DC2\ETX\SYN\STX\DC4\n\
    \\f\n\
    \\ENQ\EOT\ETX\STX\NUL\ENQ\DC2\ETX\SYN\STX\a\n\
    \\f\n\
    \\ENQ\EOT\ETX\STX\NUL\SOH\DC2\ETX\SYN\b\SI\n\
    \\f\n\
    \\ENQ\EOT\ETX\STX\NUL\ETX\DC2\ETX\SYN\DC2\DC3\n\
    \\n\
    \\n\
    \\STX\ACK\NUL\DC2\EOT\EM\NUL\GS\SOH\n\
    \\n\
    \\n\
    \\ETX\ACK\NUL\SOH\DC2\ETX\EM\b\DC1\n\
    \\v\n\
    \\EOT\ACK\NUL\STX\NUL\DC2\ETX\SUB\STX:\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\NUL\SOH\DC2\ETX\SUB\ACK\r\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\NUL\STX\DC2\ETX\SUB\SO\FS\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\NUL\ETX\DC2\ETX\SUB'6\n\
    \\v\n\
    \\EOT\ACK\NUL\STX\SOH\DC2\ETX\ESC\STX,\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\SOH\SOH\DC2\ETX\ESC\ACK\f\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\SOH\STX\DC2\ETX\ESC\r\DC2\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\SOH\ACK\DC2\ETX\ESC\GS#\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\SOH\ETX\DC2\ETX\ESC$(\n\
    \\v\n\
    \\EOT\ACK\NUL\STX\STX\DC2\ETX\FS\STX!\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\STX\SOH\DC2\ETX\FS\ACK\t\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\STX\STX\DC2\ETX\FS\n\
    \\SO\n\
    \\f\n\
    \\ENQ\ACK\NUL\STX\STX\ETX\DC2\ETX\FS\EM\GSb\ACKproto3"