...
def _nix_build_impl(ctx: AnalysisContext):
    ...
    nix_build = cmd_args([
        ...
        cmd_args(cmd_args(flake, attr, delimiter = "#"), absolute_prefix = "path:"),
    ])
...
nix_build = rule(
    ...
    attrs = {
        ...
        "attr": attrs.option(attrs.string(), doc = "name of the flake output, defaults to label name", default = None),
